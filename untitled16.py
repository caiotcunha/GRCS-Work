...
if __name__ == "__main__":
    original_file = "./database/ipv4_df.csv"  # Caminho para o dataset original
    anonymized_file = "./results/Tcrypto_Anonimized_24.csv"  # Caminho para o dataset anonimizado
